...
import com.hi.app1.domain.Report;
...
public class FileUploadController {
    ...
    public String submit1(@RequestParam("snum") String snum, @RequestParam("sname") String sname, @RequestParam("report") MultipartFile report, Model model, HttpServletRequest request) throws IOException {
    ...
    public String submit3(
        ...
        //web 경로
        String uploadRUI = "/uploadfile/report";
        //시스템 경로
        String dirRealPath = request.getSession().getServletContext().getRealPath(uploadRUI);
